...
@mytag
Scenario: 01 Check if user could add a language 
	Given I clicked on the Language tab under Profile page
	When I add a new language
	Then that language should be displayed on my listings

@mytag
Scenario: 02 Check if user could update an existing language 
	Given I clicked on the Language tab under Profile page
	When I edit the language 
	Then the updated language should be displayed on my listings

@mytag
Scenario: 03 Check if user could update the level of a language 
	Given I clicked on the Language tab under Profile page
	When I edit the level on the language
	Then the updated level should be displayed on my listings

@mytag
Scenario: 04 Check if user could remove existing language from the listing
	Given I clicked on the Language tab under Profile page
